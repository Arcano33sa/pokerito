...
commitRoute();
hooks.navigate('/historial');
commitRoute();
let back = hooks.findHeaderBackTarget(hooks.resolveHeaderRoute('/historial'));
if (back !== '/juego/mesa') throw new Error('historial back should return to mesa');
