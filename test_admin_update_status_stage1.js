...
if (!/const CACHE_NAME = 'pokerito-v0\.1\.51-(?:pdf-editorial-(?:fragmentation-stage2|final-stage3)|pdf-page-budget-stage2|pdf-route2-final-stage4)';/.test(sw)) throw new Error('missing service worker cache bump');
