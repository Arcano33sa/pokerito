...
mustContain(app, 'assets/hero/hero_admin.png', 'Administración hero asset wiring');
mustContain(app, 'assets/hero/hero_archivo.png', 'Archivo hero asset wiring');
...
const heroAdmin = path.join(root, 'assets/hero/hero_admin.png');
const heroArchivo = path.join(root, 'assets/hero/hero_archivo.png');
if (!fs.existsSync(heroAdmin)) throw new Error('hero_admin.png should exist');
if (!fs.existsSync(heroArchivo)) throw new Error('hero_archivo.png should exist');
